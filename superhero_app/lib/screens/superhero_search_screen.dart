...
class _SuperheroSearchScreenState extends State<SuperheroSearchScreen> {
  Future<SuperheroReponses?>? _superheroInfo;
  ...
  FutureBuilder<SuperheroReponses?> bodyList(bool isTextEmpty) {
  ...
  Padding itemSuperhero(SuperheroDetailResponse item) => Padding(
    ...
    child: GestureDetector(
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(16),child: Image.network(item.url, height: 400, width: double.infinity, fit: BoxFit.cover, alignment: Alignment(0,-0.6),)),
            Text(item.name, style: TextStyle(fontSize: 28, fontWeight: FontWeight.w300, color:Colors.white))
          ],
        ),
      ),
    ),
